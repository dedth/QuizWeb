...
continue_btn.onclick = ()=>{
    ...
    startTimer(15); //función de temporizador de inicio de llamada
...
restart_quiz.onclick = ()=>{
    ...
    clearInterval(counterLine); //Borrar línea de contador
    startTimer(timeValue); //función de temporizador de inicio de llamada
    startTimerLine(widthValue); //llamando a la función de línea de temporizador de inicio
...
next_btn.onclick = ()=>{
    if(que_count < questions.length - 1){ //si el número de preguntas es menor que la longitud total de la pregunta
        ...
        que_numb++; //incrementar el valor del número
        showQuetions(que_count); //llamando a mostrar la función de Preguntas
